...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC  \
),
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | shift|Voice-|Voice+|Mus on|MusOff|MidiOn|MidOff|      | mod+ | hue+ | sat+ | val+ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      | RGB Toggle  |      | mod- | hue- | sat- | val- |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, RGB_MOD,  RGB_HUI, RGB_SAI, RGB_VAI, \
  _______, _______, _______, _______, _______, RGB_TOG, RGB_TOG, _______, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD  \
)
